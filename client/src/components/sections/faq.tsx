  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">{t("faq.title", "Frequently Asked Questions")}</h2>
          <div className="w-20 h-1 bg-secondary mx-auto mb-6"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            {t("faq.description", "We answer the most common questions about our services and how we can help your business.")}
          </p>
        </motion.div>

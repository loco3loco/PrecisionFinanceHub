...
const ConsultoriaEmpresarialNuevo = lazy(() => import("@/pages/servicios/consultoria-empresarial-nuevo"));
    ...
    <>
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/servicios/consultoria-empresarial-nuevo" component={ConsultoriaEmpresarialNuevo} />

...
import { ArrowRight, Calculator, Check, Shield, Briefcase, FileText, Globe } from "lucide-react";
...
export default function AsesoriaFiscal() {
  ...
  const SERVICE_KEY = "tax_advisory";
    ...
    <>
      ...
      <section ref={refSection2} className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t(`service_pages.${SERVICE_KEY}.approach.title`)}</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t(`service_pages.${SERVICE_KEY}.approach.description`)}
            </p>
          </motion.div>
      ...
      <section ref={refSection3} className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t(`service_pages.${SERVICE_KEY}.why_choose_us.description`)}
            </p>
          </motion.div>
      ...
      <section ref={refSection4} className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t(`service_pages.${SERVICE_KEY}.cta.title`)}</h2>
